...
vi.mock("../charts/intraday/useIntradayPreview", () => ({ useIntradayPreview: vi.fn() }));

vi.mock("../charts/intraday/useIntradayDoc", () => ({
  resolveIntradayTf: () => "m15",
}));

vi.mock("../charts/intraday/IntradayDashboard", () => ({
  IntradayChartOnly: ({ symbol }: { symbol: string }) => <div data-testid="popout-chart">chart:{symbol}</div>,
}));
