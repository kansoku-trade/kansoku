...
const moduleUrl = "file:///Users/x/app/desktop/dist-main/sparkle.mjs";
...
describe("resolveSparkleAddonPath", () => {
  ...
  it("resolves next to the native build dir in dev", () => {
    ...
    expect(path).toBe("/Users/x/app/desktop/native/sparkle-bridge/build/Release/sparkle_bridge.node");
  });
});
