...
```json
{
  ...
  "fact": "MU 现价 $142.30，20日均线 $138",
  "source": "longbridge kline"
}
```
...
```json
{
  ...
  "triggers": {
    ...
    "flush_check": {
      ...
      "criteria": {
        "korea_no_new_low_2d": false,
        "margin_call_ratio_falling": true,
        "us_dram_volume_up_candle": false
      },
      "cleared_count": 1
    }
  },
...
```json
{
  ...
  "key_data": [
    {
      "fact": "长桥持仓：MU/NVDA/SMH/DRAM/QQQM 共 5 个标的",
      "source": "longbridge positions",
