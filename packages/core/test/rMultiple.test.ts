...
describe('rMultipleFor', () => {
  ...
  it('mirrors for short direction', () => {
    expect(rMultipleFor('hit_target', 'short', { entry: 100, stop: 102, target1: 95 })).toBeCloseTo(
      2.5,
      8,
    );
  });
...
describe('judgeOutcome r_multiple', () => {
  it('stamps r_multiple on resolved directional outcomes', () => {
    const winBars = [
      bar('2026-07-06T13:45:00Z', 100.5, 99.5, 100),
      bar('2026-07-06T14:15:00Z', 106, 101, 105.5),
    ];
    ...
    const loseBars = [
      bar('2026-07-06T13:45:00Z', 100.5, 99.5, 100),
      bar('2026-07-06T14:15:00Z', 100, 97, 97.5),
    ];
  ...
  it('averages r_multiple over judged trades', () => {
    const rows = [
      ...
      },
      {
        ...
        origin: 'manual' as const,
        outcome: {
          status: 'held_range' as const,
          pct_since_anchor: 0.2,
          resolved_at: 3,
          r_multiple: null,
        },
      },
