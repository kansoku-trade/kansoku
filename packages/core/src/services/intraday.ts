...
const SIGNAL_BIAS_STYLE: Record<
  'bullish' | 'bearish' | 'neutral',
...
const PATTERN_LABEL_SUFFIX: Partial<Record<CandlePatternStatus, string>> = {
  pending: '?',
  confirmed: '✓',
};
...
const MARKER_GROUP_RANK: Record<string, number> = {
  ai: 0,
  divergence: 1,
  beichi: 2,
  pattern123: 3,
