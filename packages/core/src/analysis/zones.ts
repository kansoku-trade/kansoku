...
const ZONE_PALETTE: Record<
  string,
  { label_zh: string; fill: string; border: string; axis_color: string; hint: string }
> = {
  warning: {
    label_zh: '诱多区',
...
export function normalizeSupportZones(
  rawZones: Partial<SupportZone>[] | null | undefined,
): SupportZone[] {
